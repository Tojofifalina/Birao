...
var s =  document.querySelector("#g5");
var mp =  document.querySelector("#g6");
var taona_karazany =  document.querySelector("#g7");
var batisa = document.querySelector("#g8")
...
document.addEventListener('DOMContentLoaded', function () {
    /*new Graph(document.querySelector("#g1"), {
     ...
     new Pile(document.querySelector("#g5"),{
        /**
       * @param {string} Titre
       *  @param {Array} data or @param {Array} d
       */
       data :s(),
       Titre:"Tobana anireo Mpino",
       
        argumentField: "Mpino",
        format:"P"  /* thousands: 1, millions: 2, billions: 3, trillions: 4 ,
         currency: "C", fixedpoint: "N", exponential: "", percent: "P", decimal: "D" */
    } ,)
    new Pile(document.querySelector("#g6"),{
        /**
       * @param {string} Titre
       *  @param {Array} data or @param {Array} d
       */
       data :mp(),
       Titre:"Tobana anireo Kristianina tsotra sy ireo Pandray",
       
        argumentField: "Mpino",
        format:"P"  /* thousands: 1, millions: 2, billions: 3, trillions: 4 ,
         currency: "C", fixedpoint: "N", exponential: "", percent: "P", decimal: "D" */
    } ,)
    new Pile(document.querySelector("#g7"),{
        /**
       * @param {string} Titre
       *  @param {Array} data or @param {Array} d
       */
    ...
    new Pile(document.querySelector("#g8"),{
        /**
       * @param {string} Titre
       *  @param {Array} data or @param {Array} d
       */
       data :batisa(),
       Titre:"Tobana anireo Vita batisa",
    ...
    new Pile(document.querySelector("#g10"),{
        /**
       * @param {string} Titre
       *  @param {Array} data or @param {Array} d
       */
